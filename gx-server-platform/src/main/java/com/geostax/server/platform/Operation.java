 ...
 * <p>
 * An operation is identified by an id,service pair. Two operation descriptors
 * are considred equal if they have the same id, service pair.
 * </p>
 *
...
public final class Operation {
	 ...
	 *
	 * @param id
	 *            Id of the operation, must not be <code>null</code>
	 * @param service
	 *            The service containing the operation, must not be
	 *            <code>null</code>
	 * @param method
	 *            THe method implementing the operation.
	 * @param parameters
	 *            The parameters of the operation, may be <code>null</code>
	 *
	 */
