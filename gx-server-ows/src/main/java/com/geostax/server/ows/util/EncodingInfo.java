 ...
 */
package com.geostax.server.ows.util;


/**
 * Xerces' <code>getEncodingName()</code> method of
 * <code>org.apache.xerces.impl.XMLEntityManager</code>)
...
public class EncodingInfo {
     ...
     * <code>false</code> for little-endian, and <code>null</code>
     * if byte order is not relevant for this encoding scheme.
     * This is a "three-state" switch (third is <code>null</code>),
     ...
     * (at least it was :) in <code>XmlCharsetDetector.getCharsetAwareReader</code>
     * (other two ways simply don't work).
     *
     * @param encInfo source object which properties should be mirrored in this
     *                instance
     */
