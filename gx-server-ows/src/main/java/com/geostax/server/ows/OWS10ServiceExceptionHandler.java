...
import static com.geostax.server.ows.util.ResponseUtils.baseURL;
import static com.geostax.server.ows.util.ResponseUtils.buildSchemaURL;
...
import com.geostax.server.ows.xml.v1_0.OWSConfiguration;
...
public class OWS10ServiceExceptionHandler extends ServiceExceptionHandler {
    ...
    public void handleServiceException(ServiceException exception, Request request) {
        ...
        encoder.setSchemaLocation(com.geostax.server.ows.xml.v1_0.OWS.NAMESPACE, schemaLocation);

        try {
            encoder.encode(report,com.geostax.server.ows.xml.v1_0.OWS.EXCEPTIONREPORT,
